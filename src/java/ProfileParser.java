...
public class ProfileParser {
    ...
    public static void parseProfile(String[] args) {
        String myStr = "";
        String thePath = "C:\\Users\\gracie\\Documents\\Assoc.pdf";
        ...
        try {
            PDFParser myParser = new PDFParser(new FileInputStream(myFile));
            myParser.parse();
